...
public class Config {
	...
	// The factor of velocity a meteor loses for every collision, proportional to its surface area (eg this will be lower for bigger meteors)
	public static final float INERTIA_DECAY = 3.5f;
}
