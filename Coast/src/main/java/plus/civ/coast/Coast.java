...
public class Coast extends ACivMod {
	 ...
	 */
	public void summonMeteor(World world, float x, float y, float z, float dx, float dy, float dz, float radius, Inventory inv) {
		Meteor met = new Meteor(world, x, y, z, dx, dy, dz, radius, inv);
